        ...
        <div className="col-md-6 pb-3">
            <div className="card">
                <div className="card-body">
                    <h5 className="card-title"> <img src={order.store.logo} height="100" width="100" className="img-fluid rounded-circle mr-3" alt={order.store.shop_name} /> {order.store.shop_name} </h5>
                    <div className="pb-3">
                    ...
                    <div className="pb-3">
                        <span className="card-subtitle text-muted"> {order.orderitem_count} items </span>
